...
import com.example.free.mycoolweather.db.CoolWeatherOpenHelper;
...
public class CoolWeatherDB {
    ...
    */
     ...
     * 从数据库中读取某个省下所有的城市信息
     */
    public List<City> loadCities(int provincesId)
    {
        List<City> list= new ArrayList<City>();
        Cursor cursor = db.query("City", null, "province_id=?",
                new String[]{String.valueOf(provincesId)},null,null,null);
        if(cursor.moveToFirst())
        {
            do{
                City city = new City();
